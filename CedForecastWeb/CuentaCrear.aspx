                ...
                <table border="0" cellpadding="0" cellspacing="0" class="TextoComun" style="width: 100%;
                    ...
                    <tr>
                        <td align="left" colspan="2" style="padding-left: 32px">
                            ...
                            <asp:Label ID="Label2" runat="server" Text="Disponer de una cuenta, le permitirá personalizar su perfil de usuario.   Esto le ahorrará trabajo, en el ingreso de facturas electrónicas, y disminuirá el riesgo de equivocarse en la carga de datos repetitivos."></asp:Label>

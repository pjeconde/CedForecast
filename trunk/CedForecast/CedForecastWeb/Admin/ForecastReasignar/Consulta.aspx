<%@ Page Language="C#" MasterPageFile="~/Admin/Administracion.Master" AutoEventWireup="true" CodeBehind="Consulta.aspx.cs" Inherits="CedForecastWeb.Admin.ForecastReasignar.Consulta" StylesheetTheme="Cedeira" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width:864px;" colspan="3">
                                        <asp:Label ID="TituloLabel" SkinID="TituloPagina" runat="server" Text="Reasignar datos del ..."></asp:Label>
                                        <hr />
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td align="left" style="padding-top: 10px; padding-left: 20px" valign="middle">
                            <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/Admin/ForecastReasignar/ProyectadoAnual.aspx"
                                SkinID="LinkGrandeClaro">Proyectado Anual</asp:HyperLink>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" style="padding-top: 10px; padding-left: 20px">
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/ForecastReasignar/RollingForecast.aspx"

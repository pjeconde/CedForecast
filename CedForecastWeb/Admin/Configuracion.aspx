<%@ Page Language="C#" MasterPageFile="~/Admin/Administracion.Master" AutoEventWireup="true"
    Codebehind="Configuracion.aspx.cs" Inherits="CedForecastWeb.Admin.Configuracion" Title="configuración" StylesheetTheme="Cedeira" %>
                        ...
                        <td style="" valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 392px;" valign="top">
                                        <asp:TextBox ID="FechaConfirmacionCargaTextBox" runat="server" Width="73px"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td align="right" style="height: 10px" valign="middle">
                                        <asp:Label ID="Label6" runat="server" SkinID="TituloMediano" Text="Activar:"></asp:Label>
                                    </td>
                                    <td>
                                    </td>
                                    <td align="left" style="width: 392px;" valign="top">
                                        &nbsp;<asp:CheckBox ID="ActivarCargaCheckBox" runat="server" Width="380px" Text="Activar la carga de datos." ToolTip="Marcar para activar la carga de datos." /></td>
                                </tr>
                                <tr>
                                    <td>
                                    </td>

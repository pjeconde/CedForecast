<%@ Page AutoEventWireup="true" Codebehind="ExploradorForecastProyectado.aspx.cs" Inherits="CedForecastWeb.Forecast.ExploradorForecastProyectado"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td colspan="2" style="width: 800px; height: 20px;">
                                        <asp:Label ID="TituloLabel" runat="server" SkinID="TituloPagina" Text="Proyectado Anual"></asp:Label>
                                        <hr />
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <td style="padding-left: 10px; padding-top: 10px" valign="top">
                            <asp:Panel ID="Panel1" runat="server" BackColor="peachpuff" BorderColor="brown" BorderStyle="Solid"
                                ...
                                <cc1:PagingGridView ID="ForecastPagingGridView" runat="server" OnPageIndexChanging="ForecastPagingGridView_PageIndexChanging"
                                    OnRowDataBound="ForecastPagingGridView_RowDataBound" OnSelectedIndexChanged="ForecastPagingGridView_SelectedIndexChanged"
                                    OnSorting="ForecastPagingGridView_Sorting" AllowPaging="True" AllowSorting="True"
                                    VirtualItemCount="-1">
                                    <Columns>
                                        <asp:BoundField DataField="DescrArticuloCombo" HeaderText="Artículo" SortExpression="DescrArticuloCombo">
